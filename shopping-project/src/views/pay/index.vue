    ...
    <div class="address">
      ...
      <div class="info" v-if="addressList.length > 0">
        <div class="info-content">
          <span class="name">{{ getFirstAddress.name }}</span>
          <span class="mobile">{{ getFirstAddress.phone }}</span>
        </div>
    ...
    <div class="pay-list" v-if="order.goodsList">
      <div class="list">
        <div class="goods-item" v-for="item in order.goodsList" :key="item.goods_id">
          ...
          <div class="right">
            <p class="tit text-ellipsis-2">{{ item.goods_name }}
            </p>
            <p class="info">
      ...
      <div class="pay-detail">
        ...
        <div class="pay-cell">
          <span>配送费用：</span>
          <span v-if="!getFirstAddress">请先选择配送地址</span>
...
export default {
  ...
  methods: {
    ...
    async getOrderList () {
      if (this.mode === 'cart') {
        const res = await checkoutOrder(this.mode, { cartIds: this.cartId })
        console.log(res)
  ...
  computed: {
    ...
    getLongAddress () {
      const region = this.getFirstAddress.region
      return region.province + region.city + region.region + this.getFirstAddress.detail
    },
    mode () {
